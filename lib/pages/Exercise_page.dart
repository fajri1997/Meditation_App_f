...
class _ExercisePageState extends State<ExercisePage> {
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  onTap: () => navigateToVideoPage(context, exercise.file),
                );
              },
            ),
    );
  ...
  void navigateToVideoPage(BuildContext context, String videoUrl) {
    context.go(
        '/video_page/$videoUrl'); // Use context.go to navigate to the video player route
  }
